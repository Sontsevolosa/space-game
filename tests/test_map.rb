...
class TestNAME < Test::Unit::TestCase
    ...
    def test_room()
        gold = Map::Room.new("GoldMap::Room",
                   ...
                   door to the north.""", "Funny GoldRoom")
        assert_equal("GoldMap::Room", gold.name)
        assert_equal({}, gold.paths)
    end
    
    def test_room_paths()
        center = Map::Room.new("Center", "Test room in the center.", "CenterRoom")
        north = Map::Room.new("North", "Test room in the north.", "NorthRoom")
        south = Map::Room.new("South", "Test room in the south.", "SouthRoom")
    ...
    def test_map()
        start = Map::Room.new("Start", "You can go west and down a hole.", "StartRoom")
        west = Map::Room.new("Trees", "There are trees here, you can go east.", "TreesRoom")
        down = Map::Room.new("Dungeon", "It's dark down here, you can go up.", "DungeonRoom")
